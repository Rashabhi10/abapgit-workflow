...
@UI:{
headerInfo:{
title.type: #STANDARD,typeName: 'Booking Detail',typeNamePlural: 'Booking Details',title.value: 'booking_id'}
}

define view entity yrv_m_proc_booking
  as projection on YRV_M_BOOKING_SUP as booking
{
  ...
  key booking_id,
      ...
      //YRV_M_BOOKING_SUP
      _bookCustomer,
      _bookingSupp : redirected to composition child yrv_m_proc_bookingsup,
      _carrier,
      _conn,
      _travel      : redirected to parent yrv_m_proc_travel
}
